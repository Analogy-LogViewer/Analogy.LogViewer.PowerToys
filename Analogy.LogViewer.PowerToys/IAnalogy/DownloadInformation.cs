...
namespace Analogy.LogViewer.PowerToys.IAnalogy
{
    ...
    {
        protected override string RepositoryURL { get; set; } = "https://api.github.com/repos/Analogy-LogViewer/Analogy.LogViewer.PowerToys";
        ...
        public override string Name { get; set; } = "PowerToys Logs Parser Data Provider";
